...
import * as revision from './revision.mjs';
...
export class PageHandler {
  useLocalStorage () { return $(".login").length > 0; }
  get({whenGotten,whenNotGotten,pageInformation}  ) {
    ...
    if (!this.context.length) { this.context = ['view']; }
  ...
  put($page, action) {
    ...
    // console.log 'put', action, pagePutInfo
    ...
    if (this.useLocalStorage() || (pagePutInfo.site === 'local')) {
