...
export function inject ( neighborhood ) { return sites = neighborhood.sites; }
...
export function bind () {
  ...
  return $('body')
    .on('new-neighbor', (_e, site) => $neighborhood.append(flag(site))).on('new-neighbor-done', function(/* _e, _site */) {
      // let pageCount;
      // try {
      //   pageCount = sites[site].sitemap.length;
      // } catch (error1) {
