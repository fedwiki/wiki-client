...
const siteAdapter = require('./siteAdapter.cjs');
...
wiki.asSlug = require('./page.mjs').asSlug;
wiki.newPage = require('./page.mjs').newPage;
...
const {open : dialog_open} = require('./dialog.mjs');
wiki.dialog = dialog_open;
...
const {textEditor} = require('./editor.mjs');
wiki.textEditor = textEditor;

// known use: wiki.util wiki-plugin-activity/client/activity.coffee:

wiki.util = require('./util.mjs');

// known use: wiki.security views/static.html
wiki.security = require('./security.mjs');
...
wiki.createSynopsis = require('./synopsis.mjs'); //#

// known uses: (none yet)
wiki.lineup = require('./lineup.cjs');
