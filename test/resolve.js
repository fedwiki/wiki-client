...
describe('resolve', function () {
  describe('plain text', () =>
    it('should pass unchanged', () => expect(r('The quick brown fox.')).to.eql('The quick brown fox.')))
  ...
  describe('markers', () =>
    it('should be adulterated where unexpected', () => expect(r('foo 〖12〗 bar')).to.eql('foo 〖 12 〗 bar')))
})
