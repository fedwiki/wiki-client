...
const neighborhood = require('../lib/neighborhood.cjs');

describe('neighborhood', function() {

  describe('no neighbors', () => it('should return an empty array for our search', function() {
  ...
  describe('a single neighbor with a few pages', function() {
    ...
    it('should package the results in the correct format', function() {
      ...
      return expect( searchResult.finds.page ).to.eql( expectedResult.page );
    });
  ...
  return describe('an unpopulated neighbor', function() {
    ...
    return it.skip('should re-populate the neighbor');
  });
});
